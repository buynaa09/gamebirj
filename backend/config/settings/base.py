...
ADMINS = ['"Buyntogtokh4" <buyntogtokh4@soliltsoo.com>']
...
# django-channels
# ------------------------------------------------------------------------------
# Redis is the channel-layer transport only; PostgreSQL remains the source of
# truth for conversations and messages.
