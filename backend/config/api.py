...
api.add_router("/tournaments/", "backend.tournaments.api.views.router")
api.add_router("/payments/", "backend.payments.api.views.router")
api.add_router("/banks/", "backend.banks.api.views.router")
